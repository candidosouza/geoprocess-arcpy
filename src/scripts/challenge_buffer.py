...
input_buffer01 = int(input('Digite o valor do primeiro Buffer que deseja (metros): '))
aeroports_buffer01 = settings.GEODB_DESTINY + r'\AEROPORTOS_BUFFER_' + str(input_buffer01)
...
# Declarando variáveis
input_buffer02 = int(input('Digite o valor do segundo Buffer que deseja (metros): '))
aeroports_buffer02 = settings.GEODB_DESTINY + r'\AEROPORTOS_BUFFER_' + str(input_buffer02)

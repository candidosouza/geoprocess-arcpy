####################################################################
# Nome: AnaliseAPP.py
# Descrição: Ferramenta para geração de áreas de preservação permanente de nascentes e hidrografia
# Author: Ivan Leonardi
# Curso: PYTS
####################################################################

# Importando módulos (módulo sys para lidar com exceções)
import arcpy
import sys

# Configurações de ambiente
arcpy.env.overwriteOutput = True
arcpy.env.workspace = r'C:\Users\ivanl\Desktop\PYTS\Instrutor\Exemplos\Aula 8\BaciaCabacal.gdb'
...
# Caso algo der errado, o script irá capturar exceções (nascEmpty e rioEmpty) e lidar com elas no bloco except
try:
